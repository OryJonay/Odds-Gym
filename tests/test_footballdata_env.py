...
@pytest.mark.parametrize(
    "kwargs",
    [
        {"country": "England", "league": "Premier League", "start": 1999, "end": 2011},
...
@pytest.mark.parametrize(
    "optimizer,reward1,reward2,reward3",
    [("balance", 1, 3.3, 3.3 - 1e-5), ("reward", 1, 2.3, -10 * 1e-6)],
)
def test_env(optimizer, reward1, reward2, reward3):
    env = FootballDataDailyPercentageEnv(
        config={"optimize": optimizer, "starting_bank": 10}
    )
