...
try:
    from stable_baselines import A2C, ACKTR, DDPG, DQN, PPO1, PPO2, SAC, TD3, TRPO
except ImportError:
    pytest.skip(
        "skipping stable-baselines integration tests because package is not installed",
...
ENV_DICT = {
    "BaseOddsEnv": [A2C, ACKTR, DQN, PPO1, PPO2, TRPO],
