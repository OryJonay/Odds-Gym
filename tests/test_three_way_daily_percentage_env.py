...
def test_multiple_steps_non_uniform(three_way_daily_percentage_env_non_uniform):
    ...
    current_bank += reward
    odds, reward, done, info = three_way_daily_percentage_env_non_uniform.step(array([0.0, 0.4, 0.0]))
    ...
    current_bank += reward
    odds, reward, done, info = three_way_daily_percentage_env_non_uniform.step(array([0.0, 0.15, 0.0,
                                                                                      0.135, 0, 0,
                                                                                      0.2, 0.2, 0.2]))
