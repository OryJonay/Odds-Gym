...
def test_attributes(daily_bets_percentage_env):
    assert daily_bets_percentage_env.action_space == Box(low=-ones(shape=(6,)),
                                                         high=ones(shape=(6,)))
...
@pytest.mark.parametrize("current_step,action,expected_reward,finished",
                         [(0, array([[_(0), 0., 0.], [_(0), 0., 0.]]).reshape(6), 0, False),
                          (1, array([[_(0), 0., 0.], [_(0), 0., 0.]]).reshape(6), 0, True),
                          (0, array([[_(1), 0.1, 0.], [_(1), 0.1, 0.]]).reshape(6), 2, False),
                          (1, array([[_(1), 0.1, 0.], [_(1), 0.1, 0.]]).reshape(6), 6, True),
                          (0, array([[_(1), 0.1, 0.], [_(2), 0., 0.1]]).reshape(6), -2, False),
                          (1, array([[_(1), 0.1, 0.], [_(2), 0., 0.1]]).reshape(6), 2, True),
                          (0, array([[_(2), 0., 0.1], [_(2), 0., 0.1]]).reshape(6), 0, False),
                          (1, array([[_(2), 0., 0.1], [_(2), 0., 0.1]]).reshape(6), -2, True),
                          (0, array([[_(3), 0.1, 0.1], [_(3), 0.1, 0.1]]).reshape(6), 2, False),
                          (1, array([[_(3), 0.1, 0.1], [_(3), 0.1, 0.1]]).reshape(6), 4, True)])
...
def test_attributes_of_non_uniform(daily_bets_percentage_env_non_uniform):
    assert daily_bets_percentage_env_non_uniform.action_space == Box(low=-ones(shape=(9,)),
                                                                     high=ones(shape=(9,)))
...
@pytest.mark.parametrize("current_step,action,expected_reward,finished",
                         [(0, array([_(0)] * 3 + [0.] * 6).reshape(3, 3).T.reshape(9), 0, False),
                          (1, array([_(0)] * 3 + [0.] * 6).reshape(3, 3).T.reshape(9), 0, False),
                          (2, array([_(0)] * 3 + [0.] * 6).reshape(3, 3).T.reshape(9), 0, True),
                          (0, array([_(1)] * 3 + [0.1] * 3 + [0.] * 3).reshape(3, 3).T.reshape(9), -1, False),
                          (1, array([_(1)] * 3 + [0.1] * 3 + [0.] * 3).reshape(3, 3).T.reshape(9), 3, False),
                          (2, array([_(1)] * 3 + [0.1] * 3 + [0.] * 3).reshape(3, 3).T.reshape(9), 10, True),
                          (0, array([_(3)] * 3 + [0.1] * 6).reshape(3, 3).T.reshape(9), 0, False),
                          (1, array([_(3)] * 3 + [0.1] * 6).reshape(3, 3).T.reshape(9), 2, False),
                          (2, array([_(3)] * 3 + [0.1] * 6).reshape(3, 3).T.reshape(9), 7, True),
                          (0, array([_(1), _(1), _(0), 0.1, 0.1, 0, 0, 0, 0]).reshape(3, 3).T.reshape(9), -1, False),
                          (1, array([_(1), _(2), _(0), 0.1, 0, 0, 0, 0.1, 0]).reshape(3, 3).T.reshape(9), 3, False),
                          (2, array([_(1), _(3), _(0), 0.1, 0.1, 0, 0, 0.1, 0]).reshape(3, 3).T.reshape(9), 5, True),
                          (0, array([_(2), _(1), _(0), 0, 0.1, 0, 0.1, 0, 0]).reshape(3, 3).T.reshape(9), 1, False),
                          (1, array([_(2), _(2), _(0), 0, 0.1, 0, 0, 0.1, 0]).reshape(3, 3).T.reshape(9), -1, False),
                          (2, array([_(2), _(3), _(0), 0, 0.1, 0, 0.1, 0.1, 0]).reshape(3, 3).T.reshape(9), 1, True)])
...
@pytest.mark.parametrize("current_step,action,expected_reward,finished",  # Initial bank = 10
                         ...
                         [(0, array([_(1), 0.25, 0.0]), -2.5, False),
                          # Bet size = [[1.5$, 0.75$]], Reward = 4*1.5 - 1.5 - 0.75 = 3.75
                          (1, array([_(3), 0.15, 0.075]), 3.75, False),
                          # Bet size = [[2.2$, 2$], [0, 3$], [2.7$, 0]]
                          # Reward = 4*2.2 + 5*2.7 - 2.2 - 2 - 3 - 2.7 = 12.4
                          (2, array([_(3), 0.22, 0.2, _(2), 0, 0.3, _(1), 0.27, 0]), 12.4, True),
                          # Validate not using extra odds
                          (0, array([_(1), 0.25, 0.5]), -2.5, False),
                          # Validate not using extra bets
                          (1, array([_(3), 0.15, 0.075, _(3), 0.2, 0.2]), 3.75, False),
                          # Validate non legal bet
                          (2, array([_(3), 0.22, 0.2, _(2), 0, 0.3, _(1), 0.5, 0]), -12.2, False),
                          # Validate legal bet although total percentages exceeds 100
                          (0, array([_(1), 0.25, 0.8]), -2.5, False),
                          ])
...
@pytest.mark.parametrize("action, expected_reward", [(array([_(0), 0.1, 0.0]), 0), (array([_(1), 0.1, 0.1]), -1),
                                                     (array([_(2), 0.1, 0.1]), -1), (array([_(3), 0.1, 0]), -1),
                                                     (array([_(3), 0.3, 0.8]), -11), (array([_(2), 0, 0]), 0),
                                                     (array([_(3), 0.1, 0, _(3), 0.2, 0.2]), -5),
                                                     (array([_(3), 0.1, 0.5, _(1), 0., 0.4]), -6),
                                                     (array([_(0), 0.1, 0.5, _(1), 0., 0.4]), 0)])
def test_legal_bet(daily_bets_percentage_env_non_uniform, action, expected_reward):
    _, reward, _, _ = daily_bets_percentage_env_non_uniform.step(action)
