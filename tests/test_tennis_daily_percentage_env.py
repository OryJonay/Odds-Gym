...
def test_multiple_steps(tennis_daily_percentage_env):
    odds, reward, done, info = tennis_daily_percentage_env.step(array([0, 0.1] * 3).reshape(6))
    assert reward == -2
    ...
    odds, reward, done, info = tennis_daily_percentage_env.step(array([bet_size, 0] * 3).reshape(6))
    ...
    bet_size = 1 / tennis_daily_percentage_env.balance
    odds, reward, done, info = tennis_daily_percentage_env.step(array([0, bet_size] * 3).reshape(6))
    assert reward == -1
