...
def three_way_env(request):
    soccer_bets_dataframe = DataFrame(
        [
            {
                "home_team": "FCB",
                "away_team": "PSG",
...
def tennis_env(request):
    tennis_bets_dataframe = DataFrame(
        [
            {
                "winner": "Berrettini M.",
                "loser": "Harris A.",
    ...
    tennis_bets_dataframe = DataFrame(
        [
            ...
            },
            {
                ...
                "lose": 2.7,
                "result": 0,
                "date": datetime(2020, 1, 21).date(),
            },
            {
                "winner": "Davidovich Fokina A.",
                "loser": "Gombos N.",
                "win": 1.78,
                "lose": 2.04,
                "result": 0,
